...
class Attention_Gated_UNet(AttentionGatedConvolutionalAutoEncoder):
...
class Attention_Cascade_Gated_UNet(AttentionCascadeConvolutionalAutoEncoder):
...
class AutoImplantUNet(Attention_Gated_UNet):
